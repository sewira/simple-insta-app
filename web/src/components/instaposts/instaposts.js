        ...
        <>
            {data.map(post => (
                <div className="instaposts">
                    <div className="instaposts-container" key={post.id}>
                        <div className="insta-header">
                            <img id="insta-imageProfile" src={post.imageProfile} alt="" />
                            <h6 className="insta-username">{post.username}</h6>
                            <div className="insta-option">
                                <Option />
                            </div>
                        </div>
                        <div className="insta-image">
                            <img className="insta-images" src={post.image} alt="" />
                        </div>
